...
enum class StringKey(
    ...
    fcl_vnext_dose_distribution_style(
        ...
        defaultValue = "SMOOTH",
        title = KeysStrings.fcl_vnext_dose_distribution_style,
        preferenceType = PreferenceType.LIST,
        entriesRefs = mapOf(
            "VERY_SMOOTH" to KeysStrings.fcl_dist_very_smooth,
            "SMOOTH"      to KeysStrings.fcl_dist_smooth,
            "BALANCED"    to KeysStrings.fcl_dist_balanced,
            "PULSED"      to KeysStrings.fcl_dist_pulsed,
            "VERY_PULSED" to KeysStrings.fcl_dist_very_pulsed
        )
    ),
    fcl_vnext_night_response_style(
        key = "fcl_vnext_night_response_style",
        defaultValue = "NORMAL",
        title = KeysStrings.fcl_vnext_night_response_style,
        preferenceType = PreferenceType.LIST,
        entriesRefs = mapOf(
            "VERY_GUARDED" to KeysStrings.fcl_night_very_guarded,
            "GUARDED"      to KeysStrings.fcl_night_guarded,
            "BALANCED"     to KeysStrings.fcl_night_balanced,
            "RESPONSIVE"   to KeysStrings.fcl_night_responsive,
            "PROACTIVE"    to KeysStrings.fcl_night_proactive
        )
    ),
    fcl_vnext_resistance_behavior(
        key = "fcl_vnext_resistance_behavior",
        defaultValue = "MODERATE",
        title = KeysStrings.fcl_vnext_resistance_behavior,
        preferenceType = PreferenceType.LIST,
        entriesRefs = mapOf(
            "OFF"        to KeysStrings.fcl_res_off,
            "LIGHT"      to KeysStrings.fcl_res_light,
            "NORMAL"     to KeysStrings.fcl_res_normal,
            "STRONG"     to KeysStrings.fcl_res_strong,
            "AGGRESSIVE" to KeysStrings.fcl_res_aggressive
        )
    ),
    fcl_vnext_resistance_stability(
        key = "fcl_vnext_resistance_stability",
        defaultValue = "MODERATE",
        title = KeysStrings.fcl_vnext_resistance_stability,
        preferenceType = PreferenceType.LIST,
        entriesRefs = mapOf(
            "VERY_STABLE" to KeysStrings.fcl_stab_very_stable,
            "STANDARD"    to KeysStrings.fcl_stab_standard,
            "RESPONSIVE"  to KeysStrings.fcl_stab_responsive
        )
    ),
    fcl_vnext_activity_behavior(
        key = "fcl_vnext_activity_behavior",
        defaultValue = "NONE",
        title = KeysStrings.fcl_vnext_activity_behavior,
        preferenceType = PreferenceType.LIST,
        entriesRefs = mapOf(
            "OFF"    to KeysStrings.fcl_act_off,
            "LIGHT"  to KeysStrings.fcl_act_light,
            "NORMAL" to KeysStrings.fcl_act_normal,
            "STRONG" to KeysStrings.fcl_act_strong
        )
    ),
    OchtendStart(key = "fcl_ochtend_start", defaultValue = "07:00", title = KeysStrings.OchtendStart),
    OchtendStartWeekend(key = "fcl_ochtend_start_weekend", defaultValue = "08:00", title = KeysStrings.OchtendStartWeekend),
    NachtStart(key = "fcl_nacht_start", defaultValue = "23:00", title = KeysStrings.NachtStart),
    WeekendDagen(key = "fcl_weekend_dagen", defaultValue = "6,7", title = KeysStrings.WeekendDagen),
