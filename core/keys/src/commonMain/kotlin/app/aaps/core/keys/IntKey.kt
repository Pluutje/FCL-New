...
enum class IntKey(
    ...
    fcl_vnext_sterkte(key = "fcl_vnext_sterkte", defaultValue = 100, min = 80, max = 125, title = KeysStrings.fcl_vnext_internal, unitType = UnitType.PERCENT),
    fcl_vnext_timing(key = "fcl_vnext_timing", defaultValue = 100, min = 80, max = 120, title = KeysStrings.fcl_vnext_internal, unitType = UnitType.PERCENT),
    fcl_vnext_volhoudendheid(key = "fcl_vnext_volhoudendheid", defaultValue = 100, min = 70, max = 130, title = KeysStrings.fcl_vnext_internal, unitType = UnitType.PERCENT),
    // fcl_vnext_nacht_factor(key = "fcl_vnext_nacht_factor", defaultValue = 85, min = 60, max = 110, title = KeysStrings.fcl_vnext_internal, unitType = UnitType.PERCENT),

    // ── FCL vNext — Groep 3: Analyzer-gestuurde fijnafstelling ────────────
    fcl_vnext_commit_cooldown_minutes(key = "fcl_vnext_commit_cooldown_minutes", defaultValue = 13, min = 5, max = 25, title = KeysStrings.fcl_vnext_internal, unitType = UnitType.MIN),
    fcl_vnext_early_boost_max_commits(key = "fcl_vnext_early_boost_max_commits", defaultValue = 2, min = 1, max = 3, title = KeysStrings.fcl_vnext_internal),
    fcl_vnext_sustained_rise_min_target(key = "fcl_vnext_sustained_rise_min_target", defaultValue = 12, min = 5, max = 20, title = KeysStrings.fcl_vnext_internal, unitType = UnitType.MIN),
    ;
