...
class DataHandlerMobile(
    ...
    init {
        ...
        // 09/09/2026: omgezet naar hetzelfde Flow-patroon als HeartRate/StepsRate hierboven
        // (dev verving hier de oude RxJava disposable/publish/debounce-opzet).
        rxBus.toFlow(EventData.ActionActivityType::class)
            .chunkedOnQuietPeriod(HEALTH_EVENT_QUIET_PERIOD_MS)
            .collectResilient(scope, aapsLogger, LTag.WEAR, start = CoroutineStart.UNDISPATCHED) { handleActivityTypeBatch(it) }
