...
// @ApplicationContext (Hilt) is weg: Metro's graaf levert Context al rechtstreeks (zie ook
// AndroidLoopNotifier.kt, dat "private val context: Context" ook zonder qualifier gebruikt) - er
// is hier maar één Context-binding in de graaf, dus geen qualifier nodig om te disambigueren.
